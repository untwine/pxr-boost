...
struct AToPython 
{
  ...
  {
    return pxr::boost::python::incref(pxr::boost::python::object((int)s.value).ptr());
  }
};
...
struct AFromPython 
{
  ...
  {
    void* storage = (
        (pxr::boost::python::converter::rvalue_from_python_storage< A >*)
        data)-> storage.bytes;
