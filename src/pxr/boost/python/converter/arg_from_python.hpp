...
# include "../detail/mpl2/and.hpp"
# include "../detail/mpl2/or.hpp"
# include "../detail/mpl2/not.hpp"
...
struct back_reference_arg_from_python
    : pxr::boost::python::arg_from_python<typename T::type>
{
    typedef T result_type;
    ...
    T operator()();
 private:
    typedef pxr::boost::python::arg_from_python<typename T::type> base;
    PyObject* m_source;
};
              ...
              , if_2<
                  ...
                  , if_2<
                      ...
                      , python::detail::mpl2::if_<
                            pxr::boost::python::is_back_reference<T>
