...
#ifndef PXR_BOOST_PYTHON_CONVERTER_RVALUE_FROM_PYTHON_DATA_HPP
# define PXR_BOOST_PYTHON_CONVERTER_RVALUE_FROM_PYTHON_DATA_HPP
...
struct rvalue_from_python_storage
{
    ...
    typename python::detail::referent_storage<
        typename pxr::boost::python::detail::add_lvalue_reference<T>::type
    >::type storage;
};
...
# endif
 ...
 private:
    typedef typename pxr::boost::python::detail::add_lvalue_reference<
                typename pxr::boost::python::detail::add_cv<T>::type>::type ref_type;
};
...
inline rvalue_from_python_data<T>::~rvalue_from_python_data()
{
    if (this->stage1.convertible == this->storage.bytes)
    {
        ...
        void *aligned_storage =
            std::align(pxr::boost::python::detail::alignment_of<T>::value, 0, ptr, allocated);
...
#endif // PXR_BOOST_PYTHON_CONVERTER_RVALUE_FROM_PYTHON_DATA_HPP
