...
#include <pxr/boost/python/detail/value_is_xxx.hpp>
#include <pxr/boost/python/detail/is_shared_ptr.hpp>
...
#endif // PXR_EXTERNAL_BOOST_PYTHON_DETAIL_VALUE_IS_SHARED_PTR_HPP
