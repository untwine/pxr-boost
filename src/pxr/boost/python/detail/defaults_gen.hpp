    ...
    {                                                                   \
        ...
        {                                                               \
            using type = std::tuple<                                    \
                typename ::pxr::boost::python::detail::mpl2::at_c<SigT, I>::type...           \
            >;                                                          \
        };                                                              \
                                                                        \
        using RetT = typename ::pxr::boost::python::detail::mpl2::at_c<SigT, 0>::type;        \
        using ArgT = typename get_args<                                 \
            std::make_index_sequence<pxr::boost::python::detail::mpl2::size<SigT>::value>   \
        >::type;                                                        \
                                                                        \
    ...
    {                                                                   \
        ...
        {                                                               \
            ...
            >;                                                          \
                                                                        ...
                                                                        \
        using RetT = typename ::pxr::boost::python::detail::mpl2::at_c<SigT, 0>::type;        \
        using ClassT = typename ::pxr::boost::python::detail::mpl2::at_c<SigT, 1>::type;      \
        using ArgT = typename get_args<                                 \
            std::make_index_sequence<pxr::boost::python::detail::mpl2::size<SigT>::value>   \
        >::type;                                                        \
                                                                        \
...
#define PXR_BOOST_PYTHON_OVERLOAD_CONSTRUCTORS(fstubs_name, n_args, n_dflts)                    \
    fstubs_name(char const* doc = 0)                                                        \
        : ::pxr::boost::python::detail::overloads_common<fstubs_name>(doc) {}                    \
    template <std::size_t N>                                                                \
    fstubs_name(char const* doc, ::pxr::boost::python::detail::keywords<N> const& keywords)      \
        : ::pxr::boost::python::detail::overloads_common<fstubs_name>(                           \
            doc, keywords.range())                                                          \
    {                                                                                       \
        [[maybe_unused]] typedef typename ::pxr::boost::python::detail::           \
            error::more_keywords_than_function_arguments<                                   \
                N,n_args>::too_many_keywords assertion;                                     \
    }                                                                                       \
    template <std::size_t N>                                                                \
    fstubs_name(::pxr::boost::python::detail::keywords<N> const& keywords, char const* doc = 0)  \
        : ::pxr::boost::python::detail::overloads_common<fstubs_name>(                           \
            doc, keywords.range())                                                          \
    {                                                                                       \
        [[maybe_unused]] typedef typename ::pxr::boost::python::detail::           \
...
#  define PXR_BOOST_PYTHON_GEN_FUNCTION_STUB(fname, fstubs_name, n_args, n_dflts)   \
    struct fstubs_name                                                          \
        : public ::pxr::boost::python::detail::overloads_common<fstubs_name>         \
    {                                                                           \
