...
# include "../return_by_value.hpp"
# include "../handle.hpp"
# include "../make_function.hpp"

# include "./iterator_core.hpp"
# include "./class_detail.hpp"
...
)
{
    ...
    typedef typename pxr::boost::python::detail::add_const<iterator>::type iterator_const;
    typedef typename pxr::boost::python::detail::add_lvalue_reference<iterator_const>::type iterator_cref;
