...
struct register_base_of
{
    ...
    {
        static_assert(!(pxr::boost::python::detail::is_same<Base,Derived>::value));
        ...
        this->register_downcast((Base*)0, pxr::boost::python::detail::is_polymorphic<Base>());
    }

 private:
    static inline void register_downcast(void*, pxr::boost::python::detail::false_) {}
    
    template <class Base>
    static inline void register_downcast(Base*, pxr::boost::python::detail::true_)
    {
...
struct select_held_type
  : python::detail::mpl2::if_<
        python::detail::mpl2::or_<
          ...
          , pxr::boost::python::detail::is_same<T,python::noncopyable>
        >
      , Prev
      , T
    >
...
struct class_metadata
{
    ...
    typedef python::detail::mpl2::or_<
        pxr::boost::python::detail::is_same<X1,python::noncopyable>
      , pxr::boost::python::detail::is_same<X2,python::noncopyable>
      , pxr::boost::python::detail::is_same<X3,python::noncopyable>
    > is_noncopyable;
    ...
    typedef typename python::detail::mpl2::if_<
        pxr::boost::python::detail::is_same<held_type_arg,python::detail::not_specified>, T, held_type_arg
    >::type held_type;

    // Determine if the object will be held by value
    typedef python::detail::mpl2::bool_<pxr::boost::python::detail::is_convertible<held_type*,T*>::value> use_value_holder;
    ...
    typedef python::detail::mpl2::bool_<
        python::detail::mpl2::or_<
          ...
          , pxr::boost::python::detail::is_same<held_type_arg,T>
 ...
 private:
    ...
    {
        typedef typename python::detail::mpl2::not_<pxr::boost::python::detail::is_same<T2,wrapped> >::type use_callback;
