...
#ifndef PXR_BOOST_PYTHON_NUMPY_MATRIX_HPP
#define PXR_BOOST_PYTHON_NUMPY_MATRIX_HPP
 ...
 *            a dynamic python object in a static-allocated pxr::boost::python::object or handle<>,
