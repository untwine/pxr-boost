...
#ifndef PXR_BOOST_PYTHON_NUMPY_NDARRAY_HPP
#define PXR_BOOST_PYTHON_NUMPY_NDARRAY_HPP
...
namespace pxr { namespace boost { namespace python { namespace numpy {

/**
 *  @brief A boost.python "object manager" (subclass of object) for numpy.ndarray.
 *
 *  @todo This could have a lot more functionality (like pxr::boost::python::numeric::array).
...
ndarray from_data_impl(void * data,
		       ...
		       object const & owner,
		       bool writeable,
		       typename std::enable_if< pxr::boost::python::detail::is_integral<typename Container::value_type>::value >::type * enabled = NULL)
{
...
} // namespace pxr::boost::python::numpy::detail
...
} // namespace pxr::boost::python::numpy
